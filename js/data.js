...
/* ---------- 接続経路 (ダイヤル前に選ぶ) ---------- */
const ROUTES = [
  { id:"direct",   name:"近道（直結ルート）", icon:"➡️", jitter:1.3,  bill:0.75, discon:1.5, dur:0.82, luck:1.0,
    desc:"交換局を1つ飛ばす。速くて安いが、揺れが大きく切れやすい。" },
  { id:"standard", name:"標準ルート",         icon:"🛣️", jitter:1.0,  bill:1.0,  discon:1.0, dur:1.0,  luck:1.0,
    desc:"いつもの経路。可もなく不可もなく。" },
  { id:"detour",   name:"迂回（安定回線）",   icon:"🔀", jitter:0.65, bill:1.35, discon:0.4, dur:1.18, luck:1.1,
    desc:"遠回りだが専用線を通る。安定して当たりも増えるが、遅くて通話料が高い。" }
];
...
/* ---------- チャット (IRC風): 接続後にまれに参加できる ---------- */
const CHAT_NPCS = ["Neo_Tokyo", "sysop", "lurker_99", "MODEM_MANIA", "yoru_no_hito",
  "packet_lost", "kanri-nin", "56k_forever", "ADSL_matteru", "guest0721"];
const CHAT_LINES = [
  "誰かいる?",
  "今日は回線の調子どう?",
  "うちのプロバイダ、また話中でさ…",
...
// NPCがたまに教えてくれる隠し番号のヒント
const CHAT_TIPS = [
  { dial:"31337", line:"知り合いが 31337 にダイヤルしたら変なとこ繋がったって言ってた" },
  { dial:"1997",  line:"1997 って番号、まだ生きてるらしいよ。試した?" },
  { dial:"42",    line:"42 にかけると哲学的な返事が来るってネタ、知ってる?" },
  { dial:"8080",  line:"ポート番号そのままダイヤルすると面白いことあるってさ… 8080 とか" },
  { dial:"0721",  line:"開発中のサーバーに 0721 で入れるって噂" },
  { dial:"1234567", line:"1234567 みたいな適当な番号でも稀に懸賞サーバーに当たるらしい" },
  { dial:"8888888", line:"末広がりの 8888888、縁起担ぎでかけるとご祝儀くれるとか" }
];
